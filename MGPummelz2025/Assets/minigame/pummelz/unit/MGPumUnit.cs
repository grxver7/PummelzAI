...
namespace mg.pummelz
{
    public class MGPumUnit : MGPumEntity, I18nizable
    {
        ...
        public bool hasMarker(MGPumMarkerAbility.Type marker)
        {
            return abilityCurrent != null && (abilityCurrent is MGPumMarkerAbility) && ((MGPumMarkerAbility)abilityCurrent).type == marker;
        }
    }
