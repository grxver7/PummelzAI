namespace mg.pummelz
{
    ...
    public static class MGPumEF
    {
        ...
        public static MGPumReduceDamageREffect reduceDamageByOne()
        {
        ...
        public static MGPumChangeTerrainEffect changeTerrain(MGPumSelector fieldSelector,  MGPumField.Terrain newTerrain)
        {
            return new MGPumChangeTerrainEffect(fieldSelector, newTerrain);
        }
