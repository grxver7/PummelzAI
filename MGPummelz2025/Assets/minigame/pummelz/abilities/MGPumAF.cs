namespace mg.pummelz
{
    ...
    {
        public static MGPumMarkerAbility marker(MGPumMarkerAbility.Type type)
        {
            return new MGPumMarkerAbility(type);
        }
        ...
        public static MGPumTriggeredAbility onDamage(int mindamage, MGPumEffect effect)
        {
