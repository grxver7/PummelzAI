...
{
    public class MGPumRandomAIController : MGPumStudentAIPlayerController
    {
        public const string type = "rand";

        private int checkDeadlockTurnNumber = -1;
        private int cleanDeadlockTurnNumber = -1;

        public MGPumRandomAIController(int playerID) : base(playerID)
        {
        }
